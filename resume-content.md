...
<p class="text-muted small">Last updated <strong>August 2026</strong>. For narrative context and project links, see <a href="{{ '/aboutme' | relative_url }}">About me</a> and <a href="{{ '/projects' | relative_url }}">Projects</a> — details are not duplicated here.</p>
