...
| `resume.md` | Résumé / CV page (displays `assets/img/resume-2026-03.png`) |
| `assets/img/resume-2026-03.png` | Raster résumé for the `/resume` page — regenerate from your PDF when you update |
