...
<div
  ...
  data-storage-key="sunWfuClassNotesV1"
>
  ...
  <p id="private-gate-q-hint" class="small text-muted mb-3 mb-md-4">Stuck on one? Switch the question anytime—only one correct answer is required.</p>
