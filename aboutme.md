...
- **Finance support intern** — TPV (May – June 2024), Shanghai. Vendor invoice monitoring, payment schedules, and account reconciliation.
...
- **Skills:** R, Python, Java, SQL, pandas, data visualization, machine learning (incl. XGBoost), Microsoft Excel / Office.
