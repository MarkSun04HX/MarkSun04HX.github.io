...
- **NBA player salary prediction (STA 363)** (Spring 2026, with **Cosmo Zhao**) — **R** / **R Markdown** project on **2022–23** salaries (**n = 467**); correlation-based feature control, **log(Salary)** where appropriate, **KNN** (**LOOCV** and **5-fold**), **ridge/lasso**, **regression tree**, **bagging**, and **random forest**.
